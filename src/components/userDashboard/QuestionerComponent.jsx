  ...
  return (
    <>
      <div className="container" style={{ color: "white" }}>
        ...
        <div>
            <h1 className="text-info mt-3">section 1 <span><Button onClick={()=>{setSection1(!section1)}}>{section1==false?"+":"-"}</Button></span></h1>
        ...
        <div className="form-group mt-5">
          ...
          <input
            ...
            onChange={(e) =>
              setQuestioner({ howOftenDoYouEatJunkFoodPerWeek: e.target.value })
            }
            id="inputPassword5"
        ...
        <div>
            <h1 className="text-info mt-3">section 2 <span><Button onClick={()=>{setSection2(!section2)}}>{section2==false?"+":"-"}</Button></span></h1>
        ...
        <div className="form-group mt-5">
          <label>
            Please state the types of food & beverages you eat in your general
            routine:
          </label>
          <br />
          <input
        ...
        <div className="form-group mt-5">
          <label>
            Are there any foods you cannot \ will not eat? (If yes, please state
            below)
          </label>
          <br />
          <input
        ...
        <div className="form-group mt-5">
          <label>
            Is there any other information related to food & beverages that you
            would like to add? (If yes, please state below)
          </label>
          <br />
          <input
            type="text"
        ...
        <div className="form-group mt-5">
          <label>
            Do you currently do exercise? (If yes, please state which exercises
            do you do and how frequent)
          </label>
          <br />
          <input
            type="text"
        ...
        <div className="form-group mt-5">
          <label>
            Is there any other information related to fitness & exercise that
...
<div>
            <h1 className="text-info mt-3">section 3 <span><Button onClick={()=>{setSection3(!section3)}}>{section3==false?"+":"-"}</Button></span></h1>
        ...
        <div className="form-group mt-5">
          ...
          >
            ...
            <label className="btn btn-outline-primary" htmlFor="yespainInChest">
              Yes
            </label>
            <input
              type="radio"
            ...
            <label className="btn btn-outline-primary" htmlFor="nopainInChest">
              No
            </label>
          </div>
        </div>
        ...
        <div className="form-group mt-5">
          ...
          >
            ...
            <label className="btn btn-outline-primary" htmlFor="nofaintOrDizzy">
              No
            </label>
          </div>
        </div>
        ...
        <div className="form-group mt-5">
          <label>
            Are you currently taking any medication of which we should be made
            aware of? (If yes, please state below)
          </label>
          <br />
          <input
            type="text"
            ...
            className="form-control"
            aria-describedby="passwordHelpBlock"
            value={questioner.takingAnyMedicationOfWhichWeShouldBeMadeAwareOf}
            onChange={(e) => {
              setQuestioner({
                takingAnyMedicationOfWhichWeShouldBeMadeAwareOf: e.target.value,
              });
            }}
          />
        </div>
          ...
          <div className="form-group mt-5">
            <label>
              Have you had any major\minor surgery should be made aware of? (If
